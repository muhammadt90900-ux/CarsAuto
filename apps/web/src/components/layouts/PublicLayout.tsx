...
export function PublicLayout({ children, locale }: { 
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[var(--ink-900)] dark:[background-image:radial-gradient(ellipse_80%_50%_at_50%_-5%,rgba(201,168,76,0.05)_0%,transparent_60%)]">
