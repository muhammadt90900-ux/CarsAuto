  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active
          ? 'bg-[rgba(201,168,76,0.12)] text-[var(--gold)] dark:text-[var(--gold-light)] shadow-sm'
        ...
        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/[0.07]">
          <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl
            ...
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[var(--gold)] to-[#9e6e1e]
                            flex items-center justify-center text-xs font-black text-[var(--ink-900)] flex-shrink-0">
