...
export function DealerShowroomClient({ slug, locale }: { slug: string; locale: string }) {
  ...
  const dealer = {
    ...
    city: 'Erbil', country: 'Kurdistan Region',
    tier: 'Platinum', color: '#a855f7',
    rating: 4.9, reviews: 284, listings: 142,
    ...
    established: 2015,
    description: 'One of the leading premium automotive dealerships in the Kurdistan Region, specializing in luxury and premium vehicles. Authorized dealer for Toyota, Lexus, and BMW.',
  };
                ...
                {[5,4,3,2,1].map(n => (
                  <div key={n} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 progress-bar">
                      <div className="progress-bar-fill" style={{ width:`${n === 5 ? 72 : n === 4 ? 18 : n === 3 ? 6 : 2 : 2}%` }}/>
                    </div>
