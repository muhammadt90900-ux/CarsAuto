...
function NavLink({ href, label, active }: { href: string; label: string; active?: boolean }) {
  return (
    <Link
      ...
      className={`relative px-4 py-2 mx-0.5 rounded-lg text-[0.78rem] font-semibold tracking-[0.08em] uppercase
                 transition-all duration-200 group
                 ${active
                   ? 'text-gold bg-[rgba(201,168,76,0.10)]'
                   : 'text-white/65 hover:text-white hover:bg-white/[0.06]'}`}
    >
      {label}
      <span className={`absolute bottom-0.5 start-1/2 -translate-x-1/2 h-[2px] rounded-full
    ...
    <div ref={userMenuRef} className="relative hidden md:block">
      <button
        ...
        className="flex items-center gap-2 h-8 px-3 rounded-lg
                   ...
                   hover:bg-white/[0.08] hover:-translate-y-0.5 transition-all duration-200"
      >
      ...
      <div
        className={`absolute top-full end-0 mt-2 w-52 rounded-2xl origin-top-left
    ...
    <div ref={ref} className="relative hidden md:block">
      <button
        ...
        className="flex items-center gap-1.5 h-8 px-2.5 rounded-lg
                   ...
                   hover:bg-[rgba(201,168,76,0.06)] hover:-translate-y-0.5 transition-all duration-200"
      ...
      <div
        ...
        className={`absolute top-full end-0 mt-2 w-52 rounded-xl overflow-hidden z-50 origin-top-left
    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2.5 flex-shrink-0">
              ...
              <button
                ...
                className="lg:hidden flex items-center justify-center w-9 h-9 rounded-xl
                           text-white/50 hover:text-gold hover:bg-white/[0.08] hover:-translate-y-0.5
                           transition-all duration-200"
              >
              ...
              {/* Divider — separates locale controls from action/account cluster */}
              <div className="hidden md:block w-px h-5 bg-white/[0.10] mx-1" aria-hidden="true" />
              ...
              {(!navMounted || !navUser || navUser.role !== 'USER') && (
                <Link
                  ...
                  className="hidden md:inline-flex items-center gap-1.5 h-8 px-4
                             ...
                             text-gold hover:bg-gold/25 hover:border-gold/60 hover:-translate-y-0.5
                             transition-all duration-200"
                >
          ...
          <div className="hidden md:flex items-center justify-center gap-0.5 py-1.5 border-t border-white/[0.05]">
            {navLinks.map(l => (
