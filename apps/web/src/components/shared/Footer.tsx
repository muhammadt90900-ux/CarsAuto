...
export function Footer({ locale = 'en' }: { locale?: string }) {
  ...
  return (
    <footer role="contentinfo" className="relative overflow-hidden" style={{ background: 'linear-gradient(180deg,var(--ink-900) 0%,#030710 100%)' }}>
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                ...
                <span className="text-[9px] text-[rgba(201,168,76,0.6)] uppercase tracking-widest">Premium Marketplace</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 mb-5">
              {[['24k+', 'Listings'], ['1.2k+', 'Dealers'], ['8', 'Cities'], ['4.9★', 'Rating']].map(([v, l]) => (
                <div key={l} className="rounded-xl bg-white/[0.04] border border-white/[0.05] px-3 py-2">
                  <p className="text-sm font-black text-[var(--gold)]">{v}</p>
