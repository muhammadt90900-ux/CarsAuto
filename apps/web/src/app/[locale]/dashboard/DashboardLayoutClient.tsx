'use client';
// app/[locale]/dashboard/DashboardLayoutClient.tsx
// The actual dashboard chrome (sidebar, mobile nav, role-aware routing).
// Split out from layout.tsx so layout.tsx can be a server component that
// exports `metadata` (robots: noindex) — a 'use client' file can't export
// metadata directly in the Next.js App Router.
//
