'use client';
// app/[locale]/(public)/services/[id]/error.tsx

import { useEffect } from 'react';
import { reportError } from '@/lib/monitoring';
import Link from 'next/link';

export default function ServicesDetailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    // eslint-disable-next-line no-console
    console.error('[services/[id]] page error:', error);
    reportError(error, 'services/[id]');
  }, [error]);
