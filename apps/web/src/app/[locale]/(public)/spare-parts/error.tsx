'use client';
// apps/web/src/app/[locale]/(public)/spare-parts/error.tsx
//
// Next.js requires error.tsx to be a Client Component. Catches errors
// thrown during rendering of spare-parts/page.tsx and its children.

import { useEffect } from 'react';
import { reportError } from '@/lib/monitoring';

export default function SparePartsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    // eslint-disable-next-line no-console
    console.error('[spare-parts] page error:', error);
    reportError(error, 'spare-parts');
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-20 text-center">
      ...
      <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">
        Something went wrong loading spare parts
      </h2>
