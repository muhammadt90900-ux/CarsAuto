'use client';
// app/[locale]/(public)/spare-parts/[id]/error.tsx

import { useEffect } from 'react';
import { reportError } from '@/lib/monitoring';
import Link from 'next/link';

export default function SparePartsDetailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    // eslint-disable-next-line no-console
    console.error('[spare-parts/[id]] page error:', error);
    reportError(error, 'spare-parts/[id]');
  }, [error]);
