'use client';
// app/[locale]/(public)/accessories/[id]/error.tsx

import { useEffect } from 'react';
import { reportError } from '@/lib/monitoring';
import Link from 'next/link';

export default function AccessoriesDetailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    // eslint-disable-next-line no-console
    console.error('[accessories/[id]] page error:', error);
    reportError(error, 'accessories/[id]');
  }, [error]);
