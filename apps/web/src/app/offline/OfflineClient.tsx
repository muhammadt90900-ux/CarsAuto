'use client';
// apps/web/src/app/offline/OfflineClient.tsx
//
// BUG FIX: page.tsx is a Server Component (it needs to stay one so it can
// export `metadata`), but it rendered raw onClick handlers directly in its
// JSX — event handlers can't be passed as props from a Server Component to
// the client bundle, which broke static prerendering of /offline. All the
// interactive markup (buttons + the online/offline status script) has been
// moved here, into its own Client Component, so page.tsx can stay server-side
// and just render <OfflineClient /> alongside its metadata export.
