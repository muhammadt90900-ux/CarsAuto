...
export class UpdateDealerDto {
  @ApiPropertyOptional({ description: 'Dealer name (English)', minLength: 2, maxLength: 80 })
  @IsOptional() @IsString() @MinLength(2) @MaxLength(80)  nameEn?: string;
  @ApiPropertyOptional({ description: 'Dealer name (Arabic)', minLength: 2, maxLength: 80 })
  @IsOptional() @IsString() @MinLength(2) @MaxLength(80)  nameAr?: string;
  @ApiPropertyOptional({ description: 'Dealer name (Kurdish)', minLength: 2, maxLength: 80 })
